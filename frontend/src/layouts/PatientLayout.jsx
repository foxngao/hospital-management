    ...
    <div className="flex h-screen">
      <aside className="w-64 bg-green-800 text-white p-4 space-y-2 flex flex-col justify-between">
        <div>
          ...
          <a href="/patient/xetnghiem" className="block hover:bg-blue-700 p-2 rounded">🧪 Kết quả xét nghiệm</a>

          <a href="/patient/hoso" className="block hover:bg-green-700 p-2 rounded">📋 Hồ sơ bệnh án</a>
          <a href="/patient/hoadon" className="block hover:bg-green-700 p-2 rounded">💳 Giỏ hàng & Thanh toán</a>
